...
​		**背景：**AR在近些年逐渐成为了在移动设备上的一个技术趋势和交互手段，而且它在面向儿童群体，特别是以儿童为用户的严肃游戏有许多方面可以挖掘。本文通过一个具体的app尝试提升儿童空间观念的认知能力。**方法：**分析app市场中AR相关产品的数据趋势，以及儿童空间认知能力的在不同年龄的差异，故以AR为基础的开发一款严肃游戏app，让儿童在交互中可以了解空间中形体在不同角度投影下的成像。**结果：** 通过前期调研，以及让用户体验后的问卷统计，可以初步探索得出以AR技术为基础的严肃游戏app要比传统的纸质效果更能吸引用户 **结论：**AR-app中融入的可玩性可以让儿童在解迷题时感受到趣味性和成就感，以任务驱动方式和AR交互的独特特性来提升严肃游戏的学习黏性，同时未来还可以利用app开发技术来迭代更新。故具有不错的市场价值和科研价值。
